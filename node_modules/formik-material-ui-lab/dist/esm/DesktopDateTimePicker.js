...
import MuiDesktopDateTimePicker from '@mui/lab/DesktopDateTimePicker';
...
function DesktopDateTimePicker(_a) {
    ...
    return (React.createElement(MuiDesktopDateTimePicker, __assign({}, fieldToDesktopDateTimePicker(props)), children));
}
