...
import MuiMobileDateTimePicker from '@mui/lab/MobileDateTimePicker';
...
function MobileDateTimePicker(_a) {
    ...
    return (React.createElement(MuiMobileDateTimePicker, __assign({}, fieldToMobileDateTimePicker(props)), children));
}
