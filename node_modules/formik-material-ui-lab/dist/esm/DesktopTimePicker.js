...
import MuiDesktopTimePicker from '@mui/lab/DesktopTimePicker';
...
function DesktopTimePicker(_a) {
    ...
    return (React.createElement(MuiDesktopTimePicker, __assign({}, fieldToDesktopTimePicker(props)), children));
}
